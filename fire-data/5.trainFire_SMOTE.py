...
def train_fire_model_with_smote(fireData_path):
    ...
    model_data = fireData[features].dropna()

    X = pd.get_dummies(model_data.drop(columns=['is_fire']))
    y = model_data['is_fire']
    ...
    print("\n🔥 SMOTE Fire Prediction Model Evaluation")
...
if __name__ == "__main__":
    train_fire_model_with_smote('fireData.csv')